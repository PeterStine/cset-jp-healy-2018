...
#define _dc_low()   {LATFCLR = _PORTF_RF1_MASK;}

#define _cs         LATFbits.LATF8
#define TRIS_cs     TRISFbits.TRISF8
#define _cs_high()  {LATFSET = _PORTF_RF8_MASK;}
#define _cs_low()   {LATFCLR = _PORTF_RF8_MASK;}

#define _rst        LATFbits.LATF0
#define TRIS_rst    TRISFbits.TRISF0
#define _rst_high() {LATFSET = _PORTF_RF0_MASK;}
#define _rst_low()  {LATFCLR = _PORTF_RF0_MASK;}
