...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Hall_Effect.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=HALL_EFFECT.c main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/HALL_EFFECT.o ${OBJECTDIR}/main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/HALL_EFFECT.o.d ${OBJECTDIR}/main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/HALL_EFFECT.o ${OBJECTDIR}/main.o

# Source Files
SOURCEFILES=HALL_EFFECT.c main.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Hall_Effect.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/HALL_EFFECT.o: HALL_EFFECT.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/HALL_EFFECT.o.d 
	@${RM} ${OBJECTDIR}/HALL_EFFECT.o 
	@${FIXDEPS} "${OBJECTDIR}/HALL_EFFECT.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/HALL_EFFECT.o.d" -o ${OBJECTDIR}/HALL_EFFECT.o HALL_EFFECT.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/HALL_EFFECT.o: HALL_EFFECT.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/HALL_EFFECT.o.d 
	@${RM} ${OBJECTDIR}/HALL_EFFECT.o 
	@${FIXDEPS} "${OBJECTDIR}/HALL_EFFECT.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/HALL_EFFECT.o.d" -o ${OBJECTDIR}/HALL_EFFECT.o HALL_EFFECT.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
dist/${CND_CONF}/${IMAGE_TYPE}/Hall_Effect.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/Hall_Effect.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
